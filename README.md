...
| B3 | car-price-ml frontend | JavaScript — dependency-free valuation form that runs the trained model itself, with no API and no framework. Its vocabularies and bounds are generated from the Python config; without them it refuses to run rather than validating against a guess of its own | [🧮](https://p0w3r223.github.io/car-price-ml/app/) |
| B4 | [pl-review-sense](https://github.com/P0w3r223/pl-review-sense) | NLP in Polish — TF-IDF baseline vs. HerBERT transformer fine-tuning (Hugging Face) | [🌐](https://p0w3r223.github.io/pl-review-sense/) |
| B5 | [token-budget](https://github.com/P0w3r223/token-budget) | developer tooling — parse Claude Code transcripts, attribute token cost to milestones, enforce a budget (stdlib-only) | — |
...
| P3 | [apply-scout](https://github.com/P0w3r223/apply-scout) | an LLM agent written from scratch (tool loop, budgets, guardrails) with a trajectory-evaluation harness: success rate, citation fidelity, cost per task | ✅ Live | [🌐](https://p0w3r223.github.io/apply-scout/) |
